...
export default function TaskSyntaxMCQ({
  content,
  onSubmit,
  isEvaluating,
  isCompleted
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      ...
      {/* Code Snippet containing syntax structure under question */}
      {content.codeSnippet && (
      ...
      {!isCompleted && (
        ...
        >
          {isEvaluating ? 'Verifying syntax...' : 'Verify Answer'}
        </button>
      )}
    </div>
  );
