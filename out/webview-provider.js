...
exports.VibeLearnWebviewProvider = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const fs = __importStar(require("fs"));
class VibeLearnWebviewProvider {
    ...
    _getHtmlForWebview(webview) {
        ...
        if (fs.existsSync(indexHtmlPath)) {
            ...
            html = html.replace(/(href|src)="\/assets\/([^"]+)"/g, (match, attribute, assetName) => {
    ...
    saveWorkspaceProgressFile(state) {
        ...
        try {
            ...
            const conceptMasteryScores = {};
            state.concept_graph?.nodes?.forEach((node) => {
...
exports.VibeLearnWebviewProvider = VibeLearnWebviewProvider;
VibeLearnWebviewProvider.viewType = 'vibe-learn.dashboardView';
